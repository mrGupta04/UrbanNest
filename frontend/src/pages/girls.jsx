...
function Girls() {
    ...
    async function fetchRoomData() {
        try {
            const response = await fetch(`http://localhost:3001/availgirlhostel?city=${city}&district=${subCategory}&bed_type=${roomType}&startDate=${startDate}&endDate=${endDate}`, {
                method: 'GET',
                headers: {
    ...
    function RoomSection() {
        return (
            <div className="outerroomdiv">
                <p id="roomcont">All types of Girls Hostel are available</p>
